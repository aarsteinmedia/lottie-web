...
export type { AnimationConfiguration, AnimationData, AnimationDirection, Vector2 as AnimationSegment, AnimationSettings, LottieAnimation, LottieAsset, LottieManifest, Vector2 } from './types';
