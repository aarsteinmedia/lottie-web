...
declare function getStaticValueAtTime(this: BaseProperty, _time?: number, _num?: number): string | number | number[] | import("../../types").DocumentData | import("../shapes/ShapePath").default | undefined;
