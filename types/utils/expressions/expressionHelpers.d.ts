...
declare function getValueAtTime(this: BaseProperty, frameNumFromProps: number): any;
...
declare function getStaticValueAtTime(this: BaseProperty, _time?: number, _num?: number): any;
