...
export declare function getRegisteredAnimations(): any[];
export declare function goToAndStop(value: number, isFrame?: boolean, animation?: string): void;
export declare function loadAnimation(params: AnimationConfiguration): any;
...
export declare function registerAnimation(element: HTMLElement | null, animationData?: AnimationData): any;
