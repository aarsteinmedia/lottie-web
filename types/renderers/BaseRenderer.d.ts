...
export default abstract class BaseRenderer extends FrameElement {
    ...
    createItem(layer: LottieLayer): CVCompElement | HCompElement | SVGCompElement | AudioElement | SVGShapeElement | SVGTextLottieElement | CVImageElement | ImageElement | HImageElement | CVSolidElement | NullElement | CVShapeElement | HShapeElement | CVTextElement | HTextElement | HCameraElement | FootageElement;
