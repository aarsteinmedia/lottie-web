...
export default abstract class BaseRenderer extends FrameElement {
    ...
    createItem(layer: LottieLayer): CVCompElement | HCompElement | SVGCompElement | ImageElement | AudioElement | SVGShapeElement | SVGTextLottieElement | CVTextElement | CVShapeElement | HShapeElement | FootageElement | CVImageElement | HImageElement | CVSolidElement | NullElement | HTextElement | HCameraElement;
