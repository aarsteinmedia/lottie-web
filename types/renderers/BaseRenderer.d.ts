...
export declare abstract class BaseRenderer extends FrameElement {
    ...
    createItem(layer: LottieLayer): CVCompElement | HCompElement | SVGCompElement | ImageElement | AudioElement | SVGShapeElement | SVGTextLottieElement | CVTextElement | CVShapeElement | HCameraElement | HShapeElement | FootageElement | CVImageElement | CVSolidElement | NullElement | HTextElement;
