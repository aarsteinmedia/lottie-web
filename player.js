...
import { createElementID, isServer, PreserveAspectRatio as PreserveAspectRatio$1 } from '@aarsteinmedia/lottie-web/utils';
...
}, isAudio = (asset) => { return !('h' in asset) && !('w' in asset) && 'p' in asset && 'e' in asset && 'u' in asset && 'id' in asset }, isImage = (asset) => { return 'w' in asset && 'h' in asset && !('xt' in asset) && 'p' in asset }, parseBase64 = (str) => { return str.slice(Math.max(0, str.indexOf(',') + 1)) }, isBase64 = (str) => {
    if (!str) {
        return false;
    }
 ...
 */ const download = (data, options) => {
   ...
   */ base64ToU8 = (str) => { return strToU8(isServer() ? Buffer.from(parseBase64(str), 'base64').toString('binary') : atob(parseBase64(str)), true) }, getExtFromB64 = (str) => {
