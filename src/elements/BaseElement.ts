...
export abstract class BaseElement {
  ...
  initExpressions() {
    try {
      ...
      const effectsExpressionInterface = expressionsInterfaces('effects') as typeof EffectsExpressionInterface;
      const shapeExpressionInterface = expressionsInterfaces('shape') as typeof ShapeExpressionInterface;
      const textExpressionInterface = expressionsInterfaces('text') as typeof TextExpressionInterface;
      const compExpressionInterface = expressionsInterfaces('comp') as typeof CompExpressionInterface;
