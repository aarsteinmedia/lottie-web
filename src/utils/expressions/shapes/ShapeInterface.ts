...
export class ShapeExpressionInterface {
  ...
  rectInterfaceFactory(
    ...
    const prop: RectShapeProperty = view.sh?.ty === ShapeType.Trim ? view.sh.prop : view.sh;
  ...
  starInterfaceFactory(
    ...
    const prop: StarShapeProperty = view.sh?.ty === ShapeType.Trim ? view.sh.prop : view.sh;
