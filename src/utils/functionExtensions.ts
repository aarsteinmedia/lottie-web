...
export const getDescriptor = (object: unknown, prop: PropertyKey) => {
  return Object.getOwnPropertyDescriptor(object, prop);
};
export const logPrototype = (sources: Constructor[], destination?: Constructor) => {
